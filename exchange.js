...
const token_address = '0x5ec97cD06e04dD0Ae5Fb4fa5d649223B3ec4cb0d';
const token_abi = [
  {
    "inputs": [],
...
const exchange_address = '0x969D4FEadD2c599063327eED91eA53B6c6963644';
...
async function init() {
    ...
    if (poolState['token_liquidity'] === 0
        ...
        const total_supply = web3.utils.toBN(1e18);
